...
vector<string> BoolsOn = {"true","yes","1","y","t","+","ok","okay","ок","окей","да","д","правда","plus","плюс","один","one","конечно","согласен","принять","принимаю","угу","on","o","1.0","1.00","1.000","1.000","1,0","1,00","1,000","1,000","✔","1.","1,"};
